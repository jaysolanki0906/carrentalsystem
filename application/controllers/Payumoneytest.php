 ...
 * @link      http://codeigniter.com
 */
class Payumoneytest extends MY_Controller {
	...
	public function __construct()
 {
    ...
    **/ 
	public function payment()
	{
		...
		if(isset($bookinginfo['cost_of_journey'])){
			$amount = $bookinginfo['cost_of_journey'];
		}
		if(isset($bookinginfo['total_price'])){
		...
		$surl	= site_url().'Payumoneytest/payment_success';
		$furl	= site_url().'Payumoneytest/payment_failed';
		$curl	= site_url().'Payumoneytest/payment_canceled';
    ...
    **/ 
	public function payment_success()
	{
		...
		if(isset($bookinginfo['total_price'])){ 
			$bookinginfo['cost_of_journey'] = $bookinginfo['total_price'];
		}
		$this->data['total_cst'] = $bookinginfo['cost_of_journey'];
		
		if(isset($bookinginfo['package_id'])){ 
			$this->data['records'] 		= $records = $this->dvbs_model->get_package_description( $bookinginfo['package_id'] );	
		}
		unset($bookinginfo['total_price']);
		unset($bookinginfo['package_id']);
		$bookinginfo['payment_type'] 		= "payu";
		$bookinginfo['payment_received'] 	= "1";
		$bookinginfo['transaction_id'] 		= $this->input->post("txnid");
		$bookinginfo['payer_id'] 			= $this->input->post("mihpayid");
		$bookinginfo['payer_email'] 		= $this->input->post("email");
		$bookinginfo['payer_name'] 			= $this->input->post("firstname")." ".$this->input->post("lastname");
		...
		$this->data['payment_mode'] 		= "PayUMoney";
