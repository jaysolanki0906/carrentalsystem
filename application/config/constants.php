...
define('CSS_STAR_RATING',CSS_SYSTEM_DSN.'star-rating.css');
...
define('JS_STAR_RATING',SCRIPTS_SYSTEM_DSN.'star-rating.js');
...
define('TBL_TOURPACKAGE','tourpackage');
define('TBL_HOTEL_API_SETTINGS','hotel_api_settings');
...
define('TBL_PACKAGE_BOOKINGS','package_bookings');
...
/**Tour Package IMAGES UPLOAD URLS***/
define('PACKAGE_IMG_UPLOAD_PATH_URL',UPLOADS.DS.'package_images'.DS);

/**Tour Package IMG URL FOR GET IMAGE***/
define('PACKAGE_IMG_PATH',SITEURL.UPLOADS.DS.'package_images'.DS);


//DEFAULT Tour Package IMAGE
define('DEFAULT_PACKAGE_IMG',PACKAGE_IMG_PATH.'images.jpg');
