...
<div class="col-md-12">
      ...
      <div class="btn-controls">
         <div class="btn-box-row row-fluid">
            ...
            <div class="first-box">
             ...
             <?php /*?><div class="first-box">
               <a href="<?php echo site_url();?>hotels" class="btn-box big"><i class="fa fa-home fa-3x"></i><b>Hotels</b>
               </a> 
               <p><?php echo $this->lang->line('hotel');?></p>
            </div><?php */?>
            
                   <div class="first-box">
               <a href="<?php echo site_url();?>tour" class="btn-box big"><i class="fa fa-home fa-3x"></i><b>Tour</b>
               </a> 
               <p><?php echo $this->lang->line('tourpackages');?></p>
            </div>
      ...
      <?php /*?> <a href="<?php echo SITEURL;?>document" target="_blank" class="documentation-btn">Documentation</a><?php */?>
		 <style type="text/css">
		 	.documentation-btn{
		 		position: fixed;
