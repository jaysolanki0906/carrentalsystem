...
<html lang="en">
   <head>
      ...
      <?php if(isset($this->config->item('site_settings')->site_theme) && $this->config->item('site_settings')->site_theme == "Red") {  ?>
      ...
      <link href="<?php //echo TBL_CSS_ADMIN_DATATABLE_BOOTSTRAP;?>" rel="stylesheet" /-->
          ...
          <!--   <button data-target=".navbar-ex1-collapse" data-toggle="collapse" class="navbar-toggle" type="button"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button> -->
           ...
           <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
             ...
             <a href="<?php echo base_url();?>admin">
               <div class="logo">
                  <img src="<?php echo base_url();?>/assets/ajx.jpeg" width="100" height="50" alt="Site Logo"> 
               </div>
            </a>
        ...
        <ul class="nav navbar-right top-nav">
         ...
         ?> 
            ...
            <li class="dropdown">
               ...
               <a title="<?php echo $this->lang->line('unread_bookings');?>" data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"><i class="fa fa-bell"></i> 
               <b class="caret"></b> </a>
               <div class="alert-num">
