<?php $this->load->view('site/common/auth/header.php');?>
	...
	$authUrl =  $this->facebook->login_url();
				...
				<!-- <div class="g-signin2" data-onsuccess="onSignIn" style="text-align: -webkit-center;"></div>-->
				   <?php ?><a href="<?php echo $google_login_url;?>"><img src="<?php echo IMGS_SYSTEM_DSN;?>sign-g.svg" alt="Login through Google" class="sc-icn" height="50"></a><?php ?>
				   
				   <?php /*?><a href="<?php echo $authUrl;?>"><img src="<?php echo IMGS_SYSTEM_DSN;?>sign-f.svg" alt="Login through Facebook" class="sc-icn" height="50"></a><?php */?>
