               ...
               <div class="col-md-10 padding-p-0 col-md-offset-1">
                  <div class="panel panel-default" id="booking_detailz">
                     ...
                     <div class="panel-body">
                        ...
                        <div class="col-md-12">
                           <h2 class="succ-hed"> <?php echo $this->lang->line('package_details');?> </h2>
                           <div class="payments-confar">
                              <ul>
                                 <li> <strong><?php echo $this->lang->line('package_name');?> : </strong> <?php if(isset($records[0]->package_name))  echo $records[0]->package_name; ?></li>
                                 <li> <strong><?php echo $this->lang->line('destination');?>  : </strong> <?php if(isset($records[0]->destination))  echo $records[0]->destination; ?>  </li>
                                 <li> <strong><?php echo $this->lang->line('source');?>  : </strong> <?php if(isset($records[0]->source))  echo $records[0]->source; ?>  </li>
                                  <li> <strong><?php echo $this->lang->line('dept_date');?>  : </strong> <?php if(isset($records[0]->dept_date))  echo $records[0]->dept_date; ?>  </li>
                                  <li> <strong><?php echo $this->lang->line('arrival_date');?>  : </strong> <?php if(isset($records[0]->arrival_date))  echo $records[0]->arrival_date; ?>  </li>
                                  <li> <strong><?php echo $this->lang->line('price');?>  : </strong> <?php if(isset($records[0]->price))  echo $records[0]->price; ?>  </li>
