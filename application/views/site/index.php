                     ...
                     <div role="tabpanel" class="tab-pane active" id="home">
                        <div class="trip-form-con">
                           <div class="col-md-6 bmc-fields">
                              ...
                              <div>
                                <?php /*?> <a href="javascript:void(0)" class="ilike" id="pick_airport_link" data-value="pick_airport">
                           ...
                           <div class="col-md-6 bmc-fields">
                              ...
                              <?php 
							               ...
							               if (isset($this->config->item('site_settings')->airports_status) && $this->config->item('site_settings')->airports_status=='Enable') { ?>
                              <div>
                                <?php /*?> <a href="javascript:void(0)" id="drop_airport_link" class="ilike"  data-value="drop_airport">
                                    <div class="air-car"><i class="fa fa-plane"></i> </div>
                                    <?php echo $this->lang->line('airport');?> 
                                 </a><?php */?>
...
<div class="scroll-up package">
   <div class="container">
      <div class="section-margin mb-4">
         <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="section-head"> <?php echo "Packages";?></h1>
         ...
         <div class="row">
            <ul class="bxslider" >
               ...
               <div class="col-md-4 wi-re">
             <div class="first-car white padding cs-card-card">
                              <div class="first-car-hed"><?php echo strtoupper($row->package_name);?></div>

                        <div class="first-car-img"><a href="<?php echo site_url();?>tourpackage/viewpackage/<?php echo $row->id;?>"> <img width="100%" src="<?php echo get_package_image($row->image);?>" style="border-radius:0px"> </a></div>
                              ...
                              <div class="panel-heading ters-hed">
                                ...
                                <?php /*?> <a href="<?php echo site_url();?>tourpackage/viewpackage/<?php echo $row->id;?>"  class="btn btn-danger" style="
    width: 100%;
    text-transform: capitalize;
    background: #121e31;
    border-color: #121e31;
"><?php echo 'view more';?></a><?php */?>
                              </div>
                             <?php /*?> <div class="book">
         ...
         <div class="row">
            <ul class="bxslider" >
               ...
               <div class="col-md-3 wi-re">
                  <div class="first-car">
                     <div class="first-car-hed"><?php echo strtoupper($rows->vehicle_name);?></div>

                     <div class="first-car-img"><a href="<?php echo site_url();?>packages/booking/<?php echo $rows->id;?>"> <img src="<?php echo get_vehicle_image($rows->image);?>" width="100%"/></a> </div>
                        <div class="col-md-8 padding-p-r">
                           <aside class="rate"><?php echo $this->lang->line('starts_from');?>: <?php 
						              echo $this->config->item('site_settings')->currency_symbol." ".$rows->cost_starting_from ?></aside>
