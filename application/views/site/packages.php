...
<div class="container padding-p-0 banner">
   <div class="row">
      <div class="col-md-8 padding-p-l">
         <aside class="hedding"> <?php echo "Car Packages"; ?>  </aside>
      </div>
             ...
             <div class="first-car white padding cs-card-card">
                        ...
                        <div class="first-car-img"> <img width="100%" src="<?php echo get_vehicle_image($r->image);?>"title="<?php echo $r->vehicle_name." - ".$r->model;?>"> </div>
                              ...
                              <div class="rl">
                                ...
                                <tr >
                                 <td ><?php echo $this->lang->line('fuel_type');?> </td>
                                 <td><?php echo $r->fuel_type;
                                  ?></td>
                                </tr>

                                <tr ><td ><?php echo $this->lang->line('capacity');?></td>
                                 <td  class='members'><?php echo  $r->passengers_capacity;
                                  ?>
                                  <td  class='luggage'><?php echo $r->large_luggage_capacity;
                                  ?></td> 
                                  <td  class='bags'><?php echo $r->small_luggage_capacity;
                                  ?> </td>
                                   </tr>
