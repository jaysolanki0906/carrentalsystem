...
<html>
   <head>
      ...
      <meta name="description" content="<?php if(isset($this->config->item('seo_settings')->meta_description)) echo $this->config->item('seo_settings')->meta_description; ?>" />
 	  <meta name="google-signin-client_id" content="459040189330-q2paf6t6sju1j6pblvflaignofbdeir2.apps.googleusercontent.com">
   ...
   <body>
      ...
      <div class="container-fluid padding-p-0 rlt">
                  ...
                  <div class="row">
                     <div class="col-md-12 padding-p-0">
                        <div class="top-section">
                           <div class="col-md-14">
                              <div class="col-md-3 padding-p-r">
                            ...
                            <?php if ($this->config->item('site_settings')->portal_email !='') {?>  
                           <div class="tot-top">
                              <div class="phone"> <i class="fa fa-envelope"></i> </div>
                              <aside><?php echo $this->config->item('site_settings')->portal_email;?></aside>
                           </div>
                           <?php } ?>
                              ...
                              <a href="<?php echo site_url();?>auth/create_user" >
                                 <div class="col-md-2 padding-p-r">
                                    <div class="tot-top">&nbsp;&nbsp;&nbsp; 
         ...
         <form action="<?php echo site_url().'Googlelogin/newuser'; ?>" method="post" id="gform">
      <input type="hidden" value="" name="id" id="gid">
       <input type="hidden" value="" name="name" id="gname">
        <input type="hidden" value="" name="email" id="gemail">
      </form>
