...
<div class="container">
   <div class="section-margin">
      <div class="row">
               ...
               <div class="col-md-12 padding-p-0">
                  ...
                  <div class="online">
					 ...
					 if(!isset($package_id)){
						...
						echo form_open(site_url().'welcome/package_paymentConfirmation');
					}	
					...
					?>
                     ...
                     <div class="coupon-box">
                      <div class="row">
                        ...
                        <h2 style="color:#fc585e; font-weight:bold; margin-top:10px; display: inline-block; clear: both; width: 100%;">Offer Coupons</h2>
                        <?php
						 echo "Coupon Name: ".$records[0]->coupon_code;echo "<br>";
                         echo "Coupon Name: ".$records[1]->coupon_code;echo "<br>";
                         echo "Coupon Name: ".$records[2]->coupon_code;echo "<br>";
                         echo "Coupon Name: ".$records[3]->coupon_code;echo "<br>";
                         echo "Coupon Name: ".$records[4]->coupon_code;echo "<br>";
						?>
                      </div>
                     </div>
                     </div>
                    ...
                    <!--COUPON-->
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="payments" id="cash" >
                           ...
                           <?php /*?><img src="<?php echo IMGS_SYSTEM_DSN;?>mastercard.png"/><?php */?>
                        </div>
         ...
         <?php if(isset($package_id)){ ?>
          <!---SUMMARY CONTENT-->
         <div id="package_summary_content">
         </div>
         <?php } ?>
...
function package_summary_content() {
    ...
    $("#package_summary_content").html('<img src="<?php echo IMGS_SYSTEM_DSN;?>bx_loader.gif" alt="Loader" align="middle">');
    
    $.ajax({			 
			 type: 'POST',			  
			 async: false,
			 cache: false,	
			 url: "<?php echo site_url();?>welcome/package_payment_summary_content",
			 data: '<?php echo $this->security->get_csrf_token_name();?>=<?php echo $this->security->get_csrf_hash();?>',
			 success: function(data) 
			 {
				$("#package_summary_content").html(data);
			 }		  		
    });
}
